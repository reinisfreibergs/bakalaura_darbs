...
def best_result_csv(result_file, run_file,run_name, batch_size, learning_rate, param_count):
    ...
    headers = ['file','epochs','batch size', 'learning rate', 'param count', 'min_train_loss', 'min_test_loss']
